...
### 3.2.1 Literature-Based Justification for Threshold Selection
...
-   Has explicit published precedent: studies combining pupillometry with DDM explicitly use "exclude trials with >50% missing" rules (Attention, Perception, & Psychophysics, 2023)
...
### 3.2.2 Additional Sensitivity Analyses
