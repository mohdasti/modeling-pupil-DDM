...
fig_path <- function(fig_name) {
  ...
  png_path <- file.path("../output/figures", png_name)
  pdf_path <- file.path("../output/figures", pdf_name)
  
  png_exists <- file.exists(file.path(proj_root, "output/figures", png_name)) ||
                file.exists(file.path("output/figures", png_name)) ||
                file.exists(png_path)
  
  pdf_exists <- file.exists(file.path(proj_root, "output/figures", pdf_name)) ||
                file.exists(file.path("output/figures", pdf_name)) ||
  ...
  return(if (pdf_exists) pdf_path else png_path)
}
