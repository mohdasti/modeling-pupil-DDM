...
#| message: false
#| warning: false
trial_sens <- sread("output/pupil_ddm/qc/pupil_ddm_trialcount_sensitivity.csv")
if (!is.null(trial_sens) && nrow(trial_sens) > 0) {
  ...
  cat("Trial-count sensitivity table not available.")
}
```
...
#| message: false
#| warning: false
task_strat <- sread("output/pupil_ddm/qc/pupil_ddm_task_stratified.csv")
if (!is.null(task_strat) && nrow(task_strat) > 0) {
  ...
  cat("Task-stratified correlations table not available.")
}
```
