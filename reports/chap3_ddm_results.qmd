...
2. **RT as Covariate**: In all DDM-pupil coupling models, we include RT as a covariate to control for decision state and prevent RT from confounding pupil-DDM relationships. This is critical because RT correlates with both decision processes and pupil dynamics during the response period.
